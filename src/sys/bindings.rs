// @generated by `cargo run -p xtask -- merge`. DO NOT EDIT BY HAND.
...
pub const AVSphericalProjection_AV_SPHERICAL_EQUIRECTANGULAR: AVSphericalProjection = 0;
pub const AVSphericalProjection_AV_SPHERICAL_CUBEMAP: AVSphericalProjection = 1;
pub const AVSphericalProjection_AV_SPHERICAL_EQUIRECTANGULAR_TILE: AVSphericalProjection = 2;
pub const AVSphericalProjection_AV_SPHERICAL_HALF_EQUIRECTANGULAR: AVSphericalProjection = 3;
...
pub struct AVMediaCodecDeviceContext {
    ...
    pub create_window: ::std::os::raw::c_int,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct AVOHCodecDeviceContext {
    pub native_window: *mut ::std::os::raw::c_void,
}
...
pub struct AVVulkanDeviceContext {
    pub alloc: *const VkAllocationCallbacks,
    pub get_proc_addr: PFN_vkGetInstanceProcAddr,
    pub inst: VkInstance,
    pub phys_dev: VkPhysicalDevice,
    pub act_dev: VkDevice,
    pub device_features: VkPhysicalDeviceFeatures2,
    pub enabled_inst_extensions: *const *const ::std::os::raw::c_char,
    pub nb_enabled_inst_extensions: ::std::os::raw::c_int,
    pub enabled_dev_extensions: *const *const ::std::os::raw::c_char,
    pub nb_enabled_dev_extensions: ::std::os::raw::c_int,
    pub queue_family_index: ::std::os::raw::c_int,
    pub nb_graphics_queues: ::std::os::raw::c_int,
    pub queue_family_tx_index: ::std::os::raw::c_int,
    pub nb_tx_queues: ::std::os::raw::c_int,
    pub queue_family_comp_index: ::std::os::raw::c_int,
    pub nb_comp_queues: ::std::os::raw::c_int,
    pub queue_family_encode_index: ::std::os::raw::c_int,
    pub nb_encode_queues: ::std::os::raw::c_int,
    pub queue_family_decode_index: ::std::os::raw::c_int,
    pub nb_decode_queues: ::std::os::raw::c_int,
    pub lock_queue: ::std::option::Option<
        unsafe extern "C" fn(ctx: *mut AVHWDeviceContext, queue_family: u32, index: u32),
    >,
    pub unlock_queue: ::std::option::Option<
        unsafe extern "C" fn(ctx: *mut AVHWDeviceContext, queue_family: u32, index: u32),
    >,
    pub qf: [AVVulkanDeviceQueueFamily; 64usize],
    pub nb_qf: ::std::os::raw::c_int,
}
...
pub struct AVVulkanFramesContext {
    ...
    pub create_pnext: *mut ::std::os::raw::c_void,
    pub alloc_pnext: [*mut ::std::os::raw::c_void; 8usize],
    pub flags: AVVkFrameFlags,
    pub img_flags: VkImageCreateFlags,
    pub format: [VkFormat; 8usize],
    pub nb_layers: ::std::os::raw::c_int,
    pub lock_frame: ::std::option::Option<
        unsafe extern "C" fn(fc: *mut AVHWFramesContext, vkf: *mut AVVkFrame),
    >,
    pub unlock_frame: ::std::option::Option<
        unsafe extern "C" fn(fc: *mut AVHWFramesContext, vkf: *mut AVVkFrame),
    >,
}
#[repr(C)]
...
pub struct AVVkFrame {
    pub img: [VkImage; 8usize],
    pub tiling: VkImageTiling,
    pub mem: [VkDeviceMemory; 8usize],
    pub size: [usize; 8usize],
    pub flags: VkMemoryPropertyFlagBits,
    pub access: [VkAccessFlagBits; 8usize],
    pub layout: [VkImageLayout; 8usize],
    pub sem: [VkSemaphore; 8usize],
    pub sem_value: [u64; 8usize],
...
unsafe extern "C" {
    ...
    pub fn av_vkfmt_from_pixfmt(p: AVPixelFormat) -> *const VkFormat;
    pub fn av_vk_get_optional_instance_extensions(
